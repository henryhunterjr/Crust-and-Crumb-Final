...
const TikTokIcon = ({ size = 20 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.3[...]
  </svg>
);
...
const BAKERS_RESOURCE_LINKS = [
  { title: 'Fresh Milled Recipes', url: 'https://skoo.ly/fresh-mill-recipes' },
  { title: 'The Recipe Pantry', url: 'https://skoo.ly/recipepantry' },
  { title: 'The Holiday Bake', url: 'https://skoo.ly/holiday-bake' },
  { title: 'Holiday Shopping Guide', url: 'https://skoo.ly/holiday-guide' },
  { title: 'Sourdough Starter Guide', url: 'https://skoo.ly/starter-guide' },
  { title: 'Price Your Loaf Calculator', url: 'https://skoo.ly/price-your-loaf' },
  { title: 'The Sourdough Yeast Converter', url: 'https://skoo.ly/sourdough-converter' },
  { title: 'Fermentation Compass', url: 'https://skoo.ly/fermentation-compass' },
  { title: 'The Bread Authority', url: 'https://skoo.ly/bread-authority' },
];
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      id: 'welcome',
      role: 'model',
      text: "Hey there, baker! I'm Krusty, your friendly bread concierge. I'm here to help you on your sourdough journey using wisdom from Henry's book. Ask me about techniques, schedules, or troubleshooting.",
      timestamp: Date.now()
    }
  ]);
                ...
                {activeToolTab === 'calculator' && <>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-bold text-slate-700 flex items-center gap-2">
                      ...
                      Baker&apos;s Resource Library
                    </h3>

                    <div className="grid gap-3 md:grid-cols-2">
                      {BAKERS_RESOURCE_LINKS.map((resource) => (
                        <a
                          key={resource.title}
                          href={resource.url}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block rounded-xl border border-amber-200 bg-amber-50/70 p-3.5 transition-all hover:-translate-y-0.5 hover:bg-amber-100 hover:border-amber-300"
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <div className="font-semibold text-slate-800 text-sm leading-snug">{resource.title}</div>
                              <div className="mt-1 text-[11px] uppercase tracking-[0.14em] text-amber-700/80">Resource</div>
                            </div>
                            <ExternalLink size={14} className="mt-1 shrink-0 text-amber-700 opacity-70 group-hover:opacity-100" />
                          </div>
                        </a>
                      ))}
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <a
                      href="https://skoo.ly/sourdough-converter"
                      target="_blank"
                      rel="noopener noreferrer"
